...
// you must redefine all the configuration in you node_config.h
    ...
    #define PIPE_RX_DMA_CHANNEL               LL_DMA_STREAM_5
    #define PIPE_RX_DMA_REQUEST               LL_DMA_CHANNEL_4
    ...
    #define PIPE_TX_DMA_CHANNEL               LL_DMA_STREAM_6
    #define PIPE_TX_DMA_REQUEST               LL_DMA_CHANNEL_4
    #define PIPE_TX_DMA_TC(PIPE_TX_DMA)       LL_DMA_IsActiveFlag_TC6(PIPE_TX_DMA)
    #define PIPE_TX_DMA_CLEAR_TC(PIPE_TX_DMA) LL_DMA_ClearFlag_TC6(PIPE_TX_DMA)
    #define PIPE_TX_DMA_IRQ                   DMA1_Stream6_IRQn
    #define PIPE_TX_DMA_IRQHANDLER()          DMA1_Stream6_IRQHandler()
#endif
