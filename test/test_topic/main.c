...
void unittest_PubSub_IsTopicSubscribed(void)
{
    NEW_TEST_CASE("Search Topics");
    {
        ...
        TEST_ASSERT_TRUE(PubSub_IsTopicSubscribed(default_sc.App_1.app->ll_service, 1));
        TEST_ASSERT_FALSE(PubSub_IsTopicSubscribed(default_sc.App_2.app->ll_service, 1));
        TEST_ASSERT_FALSE(PubSub_IsTopicSubscribed(default_sc.App_1.app->ll_service, 18));
        TEST_ASSERT_TRUE(PubSub_IsTopicSubscribed(default_sc.App_2.app->ll_service, 18));
    }
}
...
void unittest_Luos_Subscribe(void)
{
    ...
    NEW_TEST_CASE("Add max topics number");
    {
        ...
        TEST_ASSERT_FALSE(PubSub_IsTopicSubscribed(default_sc.App_1.app->ll_service, LAST_TOPIC));
    }
}
