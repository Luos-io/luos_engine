...
This project demonstrate how to drive and connect a stepper motor to a simpleFOC arduino shield, with Arduino Zero. Feel free to use electronics and code example as you want.
...
For this type of motor we need to use an L298N driver shield provided by SimpleFOC.

For the wiring of the stepper you should follow the following design:

Add Stepper image here
