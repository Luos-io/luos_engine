...
#define PWM_1_AF   GPIO_AF1_TIM1

#define PWM_2_PIN  GPIO_PIN_3
#define PWM_2_PORT GPIOB
#define PWM_2_AF   GPIO_AF1_TIM2

#define PWM_1_TIMER   TIM1
#define PWM_1_CHANNEL LL_TIM_CHANNEL_CH2

#define PWM_2_TIMER   TIM2
#define PWM_2_CHANNEL LL_TIM_CHANNEL_CH2

#define PWM_3_PIN  GPIO_PIN_0
#define PWM_3_PORT GPIOA
#define PWM_3_AF   GPIO_AF1_TIM2

#define PWM_4_PIN  GPIO_PIN_2
#define PWM_4_PORT GPIOA
#define PWM_4_AF   GPIO_AF1_TIM2

#define PWM_3_TIMER   TIM2
#define PWM_3_CHANNEL LL_TIM_CHANNEL_CH1

#define PWM_4_TIMER   TIM2
#define PWM_4_CHANNEL LL_TIM_CHANNEL_CH3
/*******************************************************************************
 * Definitions
 ******************************************************************************/
