...
# Galvo driver using XY2-100 protocol

Driver for using a laser galvo using XY2-100 protocol in your projects with Luos.

# Linked project

This driver is linked to the [Galvo project](../../Projects/NUCLEO_L476RG/laser).
