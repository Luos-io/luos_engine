...
/******************************************************************************
 * @brief Driver init must be called in LedFader_Init
 * @param None
 * @return None
 ******************************************************************************/
void LedFaderDrv_Init(void)
{
    LedTIM2_Init();
    LedTIM3_Init();
...
/******************************************************************************
 * @brief LedFader driver write function puts the color to the led
 * @param color_t rgb value
