...
You can open [a working example electronic design](https://github.com/Luos-io/luos_engine/tree/main/examples/hardware) with Kicad. This design uses Luos_components library. For more information to install and use it, read [our doc](https://docs.luos.io).
