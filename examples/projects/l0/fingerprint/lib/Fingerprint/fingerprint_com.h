...
#define FINGERPRINT_COM_TX_PIN  GPIO_PIN_0
#define FINGERPRINT_COM_TX_PORT GPIOA
#define FINGERPRINT_COM_TX_AF   GPIO_AF4_USART4

#define FINGERPRINT_COM_RX_PIN  GPIO_PIN_1
#define FINGERPRINT_COM_RX_PORT GPIOA
#define FINGERPRINT_COM_RX_AF   GPIO_AF4_USART4

/*******************************************************************************
 * FINGERPRINT_COM CONFIG
 ******************************************************************************/
#define FINGERPRINT_COM_CLOCK_ENABLE() __HAL_RCC_USART4_CLK_ENABLE()

#define FINGERPRINT_COM              USART4
#define FINGERPRINT_COM_IRQ          USART3_4_IRQn
#define FINGERPRINT_COM_IRQHANDLER() USART3_4_IRQHandler()
